...
# Parameters settings
# Data loading params
#tf.flags.DEFINE_string("database_path", "/home/nujud/Desktop/datset/", "Path for the dataset to be used.") # fack checking dataset
tf.flags.DEFINE_string("database_path", "/Users/idcpt1212/PycharmProjects/ahad1/Residual_learninig/", "Path for the dataset to be used.")
...
def train(x_train, y_train, x_test, y_test):
    ...
    checkpointer = ModelCheckpoint(filepath="/home/nujud/Desktop/VDCNN-keras_version (1)/logs/checkpoints/vdcnn_weights_val_acc_{val_acc:.4f}.h5", period=1,
